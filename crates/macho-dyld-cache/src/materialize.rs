...
pub(super) fn materialize_cache_image(
    ...
    use macho_core::format::constants::{LC_SEGMENT, LC_SEGMENT_64};
    use macho_core::model::{Bitness, MagicNumber};
    ...
    macho_core::format::parse(&bytes).map_err(Error::from)?;
...
fn parse_cache_segment(
    ...
    command_size: usize,
    is_64: bool,
    endian: macho_core::format::io::Endian,
...
fn build_linkedit_layout(
    ...
    bitness: macho_core::model::Bitness,
    endian: macho_core::format::io::Endian,
) -> Result<LinkeditLayout> {
    use macho_core::format::constants::*;
    use macho_core::model::Bitness;
