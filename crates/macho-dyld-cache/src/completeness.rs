...
pub(super) fn completeness_for(
    ...
    macho: &macho_core::model::MachoFile<'_>,
) -> ReconstructionCompleteness {
    use macho_core::model::LoadCommand;
    ...
    ReconstructionCompleteness {
        ...
        symbols: if has_symbols {
            match macho_core::format::parse_symbol_table(macho) {
        ...
        exports: if has_exports {
            match macho_dyld::parse_exports(macho) {
        ...
        imports: if has_imports {
            match macho_dyld::collect_imports(macho) {
        ...
        fixups: if has_fixups {
            ...
            if chained {
                match macho_dyld::parse_chained_fixups(macho) {
                ...
                match (
                    macho_dyld::parse_rebase_entries(macho),
                    macho_dyld::parse_bind_entries(macho),
                ) {
