use crate::analysis::audit::{AuditReport, AuditSeverity};
use anyhow::Result;
use serde::Serialize;
...
pub fn render(path: &Path, reports: &[AuditReport]) -> Result<String> {
    ...
    for report in reports {
        for finding in &report.findings {
            if seen_rules.insert(finding.rule_id.as_str()) {
...
fn format_message(arch: &str, finding: &crate::analysis::audit::AuditFinding) -> String {
