...
//! against the theme is [`Style`](crate::cli::commands::output::Style)'s job, so
...
mod tests {
    ...
    fn spans_carry_semantic_tokens() {
        let text = "mov rax, qword ptr [rip+0xff00]";
        ...
        assert_eq!(token_of(text, "0xff00"), tokens::SYNTAX_NUMBER);
