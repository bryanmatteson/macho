...
pub(crate) fn run(
    args: InfoArgs,
    output: crate::cli::commands::output::Options,
    out: &mut dyn Write,
    ...
    if format == OutputFormat::Json {
        ...
        let outcome = crate::parse_with_options(&bytes, &options)?;
