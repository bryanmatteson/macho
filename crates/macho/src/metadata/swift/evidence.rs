...
use crate::metadata::swift::types::{SwiftTypeKind, SwiftTypeSource};
...
struct ClassDispatchValidationError {
    attempted: u64,
    gap: Box<SwiftDecodeGapV1>,
    retained_vtable_entries: Vec<MachoSwiftClassVtableEntryV1>,
    retained_overrides: Vec<MachoSwiftClassOverrideRecordV1>,
}
