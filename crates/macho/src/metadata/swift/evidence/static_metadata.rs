...
use crate::core::format::symbols::fold_symbols;
...
impl crate::metadata::swift::SwiftDemangler for NoSymbolDemangler {
    fn demangle(&self, _symbol: &str) -> crate::metadata::swift::Result<Option<String>> {
        Ok(None)
    }
}
