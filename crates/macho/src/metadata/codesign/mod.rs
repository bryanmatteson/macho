...
//!
//! Use [`crate::metadata::codesign::parse_code_signature`] on a
//! [`crate::core::MachoFile`], or
//! [`crate::metadata::codesign::superblob::parse_super_blob`] on raw blob bytes.
...
use crate::metadata::codesign::model::addr::ThinFileOffset;
use crate::metadata::codesign::model::ext::MachoExt;
use crate::metadata::codesign::model::load_command::LoadCommand;
use crate::metadata::codesign::model::macho_file::MachoFile;
...
mod tests {
    use super::*;
    use crate::metadata::codesign::types::CSMAGIC_BLOBWRAPPER;
