...
use crate::metadata::objc::format::io::pod::{self, RawMethodListHeader, RawPropertyT};
use crate::metadata::objc::model::addr::Va;
use crate::metadata::objc::resolve::ObjCResolver;
use crate::metadata::objc::types::{METHOD_LIST_ENTSIZE_MASK, ObjCProperty};

/// Performs parse_property_list.
...
/// Performs parse_property_list_with_kind.
