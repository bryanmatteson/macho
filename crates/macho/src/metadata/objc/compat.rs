...
fn type_width(ty: &ObjCType) -> Option<usize> {
    match ty {
        ...
        ObjCType::Long
        | ObjCType::UnsignedLong
        | ObjCType::LongLong
        | ObjCType::UnsignedLongLong
        | ObjCType::Double => Some(8),
        ObjCType::Pointer(_)
        | ObjCType::Object { .. }
        | ObjCType::CharPtr
        | ObjCType::CString
...
mod tests {
    use super::*;
    use crate::metadata::objc::encoding::ObjCMethodArg;

    fn make_sig(ret: ObjCType, args: Vec<ObjCType>) -> ObjCMethodSignature {
        ObjCMethodSignature {
    ...
    fn struct_name_mismatch() {
        let a = ObjCType::Struct {
            name: "CGRect".into(),
            fields: vec![],
        };
        let b = ObjCType::Struct {
            name: "CGSize".into(),
            fields: vec![],
        };
