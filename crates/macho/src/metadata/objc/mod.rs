...
//!
//! Parse a [`crate::core::MachoFile`] with
//! [`crate::metadata::objc::parse_objc_metadata`] or borrow a raw byte source
//! with [`crate::metadata::objc::parse_objc_metadata_from_source`].
...
use crate::metadata::objc::model::ext::MachoExt;
...
/// architecture is a caller decision; parse those with [`crate::core::parse`]
