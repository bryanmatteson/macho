...
#[cfg(feature = "fixups")]
impl From<crate::metadata::dyld::DyldError> for ObjcError {
    fn from(source: crate::metadata::dyld::DyldError) -> Self {
        let message = source.message().to_owned();
        let kind = match source.kind {
            crate::metadata::dyld::DyldErrorKind::InvalidFormat => ObjcErrorKind::InvalidFormat,
            crate::metadata::dyld::DyldErrorKind::OutOfBounds => ObjcErrorKind::OutOfBounds,
            crate::metadata::dyld::DyldErrorKind::InvalidAddress => ObjcErrorKind::InvalidAddress,
            crate::metadata::dyld::DyldErrorKind::Unsupported => ObjcErrorKind::Unsupported,
            crate::metadata::dyld::DyldErrorKind::Core => ObjcErrorKind::Core,
        };
