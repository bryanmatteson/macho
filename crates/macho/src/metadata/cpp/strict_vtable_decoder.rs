...
use super::*;
use crate::metadata::cpp::strict_rtti::decoder::{StrictDecoder, checked_add};
use crate::metadata::cpp::strict_rtti::{StrictPointerTarget, StrictRttiGapCode};
    ...
    for (symbol, kind) in candidates {
        ...
        match decoded {
            ...
            Err(error) => {
                ...
                } else if error.kind == crate::metadata::cpp::CppErrorKind::InvalidAddress {
                    StrictRttiGapCode::PointerUnresolved
                } else if error.kind == crate::metadata::cpp::CppErrorKind::Unsupported {
