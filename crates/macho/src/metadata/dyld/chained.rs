...
use crate::metadata::dyld::format::io::endian::Endian;
use crate::metadata::dyld::format::io::pod::{
    self, RawChainedFixupsHeader, RawChainedImport, RawChainedImportAddend,
    RawChainedImportAddend64,
};
use crate::metadata::dyld::model::addr::ThinFileOffset;
use crate::metadata::dyld::model::load_command::LoadCommand;
use crate::metadata::dyld::model::macho_file::MachoFile;
use crate::metadata::dyld::types::{ChainedImport, ChainedImportRecord, Fixup, FixupKind};
...
) -> Result<Option<&'image crate::metadata::dyld::model::load_command::LinkeditData>> {
