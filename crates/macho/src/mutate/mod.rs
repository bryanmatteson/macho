...
use crate::mutate::model::load_command::*;
...
impl LoadCommandEditExt for crate::core::model::load_command::LoadCommand {
    fn new_rpath(path: &str) -> Self {
...
/// The mutate module.
pub mod mutate {
    pub use crate::mutate::layout;
    pub use crate::mutate::owned;
    pub use crate::mutate::preview;
    #[cfg(feature = "external-signing")]
    pub use crate::mutate::resign;
    pub use crate::mutate::transaction;
    pub use crate::mutate::{AddSection, LoadCommandEditExt, MachoEditor, SectionContent};
}
