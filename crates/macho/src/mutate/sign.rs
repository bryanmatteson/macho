...
<plist version="1.0"><dict><key>com.apple.security.get-task-allow</key><true/></dict></plist>"#;
    ...
    fn covered_byte_tampering_is_rejected() {
        ...
        let parsed = crate::core::parse(&signed).expect("parse signed output");
    ...
    fn resigning_preserves_identifier_and_entitlements() {
        ...
        let parsed = crate::core::parse(&resigned).expect("parse re-signed output");
    ...
    fn corrupted_nonempty_cms_is_rejected_in_both_modes() {
        ...
        let cms_payload = {
            ...
            signature
                .blobs()
                .iter()
                .find(|blob| blob.blob_type == crate::metadata::codesign::BlobType::Signature)
