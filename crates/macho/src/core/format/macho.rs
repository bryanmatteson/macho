...
use crate::core::format::constants::MachoHeaderFlags;
use crate::core::format::io::pod::{self, RawMachHeader32, RawMachHeader64};
use crate::core::model::header::*;
...
pub(crate) fn parse_macho_file_with_limits<'data>(
    ...
    let (load_commands, segments) =
        crate::core::format::load_commands::parse_load_commands_with_limits(
            data,
            endian,
            lc_offset,
            header.ncmds,
