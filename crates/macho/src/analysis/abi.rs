...
use crate::analysis::core::model::macho_file::MachoFile;
use crate::analysis::core::model::symbol::SymbolTable;
use crate::analysis::cpp::VtableIndex;
use crate::analysis::dwarf::DwarfFunctionIndex;
use crate::analysis::dwarf::types::{DwarfFunctionInfo, DwarfType};
use crate::analysis::objc::ObjCMetadata;
use crate::analysis::objc::compat::{self, IssueSeverity as ObjCSeverity};
use crate::analysis::objc::encoding::ObjCMethodSignature;
...
pub fn check_symbol_compat(
    ...
    let t_body = crate::analysis::reconstruct::cpp::abi::analyze_symbol_body(
        target, &t_symtab, t_sym_ref, None,
    );
    let p_body = crate::analysis::reconstruct::cpp::abi::analyze_symbol_body(
        provider, &p_symtab, p_sym_ref, None,
    );
    ...
    if let (Some(tb), Some(pb)) = (&t_body, &p_body) {
        ...
        use crate::analysis::reconstruct::cpp::types::CppReturnChannel;
...
fn find_objc_method<'a>(
    ...
    selector: &str,
    is_instance: bool,
) -> Option<&'a crate::analysis::objc::types::ObjCMethod> {
