...
impl ObjCGraph {
    ...
    pub fn method_impl_offset(
        ...
        macho
            .address_map()
            .va_to_thin_offset(crate::core::model::addr::Va(va))
            .ok()
    }
...
impl<'data> MachoExt<'data> for ObjCGraph {
    type Error = crate::analysis::objc::ObjcError;

    fn parse<'mf>(macho: &'mf MachoFile<'data>) -> crate::analysis::objc::Result<Self>
    where
        'data: 'mf,
    {
