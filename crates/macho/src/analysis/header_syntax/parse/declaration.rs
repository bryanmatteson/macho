use crate::analysis::header_syntax::{CallingConvention, Decl, Language, RecordKind, Type};
...
pub(super) fn lower_record(text: &str, language: Language) -> Result<Decl, ParseError> {
    ...
    let mut access = match kind {
        RecordKind::Class => crate::analysis::header_syntax::Access::Private,
        _ => crate::analysis::header_syntax::Access::Public,
    };
        ...
        for declaration in lower_declaration(statement, language)? {
            match declaration {
                Decl::Variable { name, ty, .. } => {
                    fields.push(crate::analysis::header_syntax::Field {
                        name,
                        ty,
                        offset: None,
                        bit_width: None,
...
fn strip_access_specifier(
    text: &str,
    current: crate::analysis::header_syntax::Access,
) -> (crate::analysis::header_syntax::Access, &str) {
    for (prefix, access) in [
        ("public:", crate::analysis::header_syntax::Access::Public),
        (
            "protected:",
            crate::analysis::header_syntax::Access::Protected,
        ),
        ("private:", crate::analysis::header_syntax::Access::Private),
    ] {
