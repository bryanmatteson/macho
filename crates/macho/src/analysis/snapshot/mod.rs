...
use crate::analysis::codesign::{CodeSignature, HashType};
use crate::analysis::dyld::chained::parse_chained_fixups;
use crate::analysis::dyld::exports::parse_exports;
use crate::analysis::dyld::imports::{ImportRecord, collect_imports};
use crate::analysis::dyld::types::ExportKind;
use crate::analysis::error::{
    CODESIGN_FAILED_CODE, EXPORTS_FAILED_CODE, FIXUPS_FAILED_CODE, IMPORTS_FAILED_CODE,
    SYMBOLS_FAILED_CODE,
};
use crate::analysis::format::constants::VmProtection;
use crate::analysis::model::load_command::LoadCommand;
use crate::analysis::model::load_command::format_uuid;
...
fn snap_fixup(fixup: crate::analysis::dyld::types::Fixup) -> FixupSnapshot {
