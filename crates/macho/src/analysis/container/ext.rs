use crate::analysis::container::{FilesetEntryInspection, FilesetMemberReport};
use crate::analysis::format::parse;
use crate::analysis::model::container::{FatBinary, MachoContainer};
