...
use crate::metadata::dwarf::types::DwarfType;
...
pub(super) fn cpp_type(value: &crate::analysis::reconstruct::cpp::CppType) -> Option<HeaderType> {
    use crate::analysis::reconstruct::cpp::CppType;
    Some(match value {
