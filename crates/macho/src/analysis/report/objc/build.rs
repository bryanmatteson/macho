...
use crate::metadata::objc::{ObjCMetadataScan, ObjCRecordKind};
...
) -> crate::analysis::Result<ObjCReport> {
...
pub fn recover_objc_surface(macho: &MachoFile<'_>) -> crate::analysis::Result<ObjCReport> {
    ...
    let scan = crate::metadata::objc::scan_objc_metadata(macho)?;
...
fn class_entity(
    value: &crate::metadata::objc::ObjCClass,
    id: ObjCEntityId,
...
fn category_entity(
    value: &crate::metadata::objc::ObjCCategory,
    ordinal: usize,
    id: ObjCEntityId,
    observation_id: ObjCObservationId,
    evidence_id: ObjCEvidenceId,
...
fn protocol_entity(
    value: &crate::metadata::objc::ObjCProtocol,
    id: ObjCEntityId,
    observation_id: ObjCObservationId,
    evidence_id: ObjCEvidenceId,
    context: &mut EntityBuildContext<'_, '_>,
) -> ObjCProtocolEntity {
    let mut methods = |values: &[crate::metadata::objc::ObjCMethod], kind, scope| {
        values
            .iter()
            .enumerate()
            .map(|(ordinal, item)| {
