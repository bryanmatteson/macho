...
fn data_surface_flags_parse_and_enforce_dependencies() {
    ...
    .unwrap();
    assert!(macho::cli::commands::parse_only(["macho", "strings", "fixture", "--exact"]).is_err());
    assert!(
        macho::cli::commands::parse_only(["macho", "strings", "fixture", "--min-length", "0",])
            .is_err()
    );
    macho::cli::commands::parse_only([
        "macho",
    ...
    assert!(
        macho::cli::commands::parse_only(["macho", "xrefs", "fixture", "--kind", "bogus"]).is_err()
    );
    macho::cli::commands::parse_only([
    ...
    .unwrap();
    assert!(
        macho::cli::commands::parse_only(["macho", "ranges", "fixture", "--source", "bogus"])
            .is_err()
    );
    macho::cli::commands::parse_only([
        "macho",
    ...
    macho::cli::commands::parse_only(["macho", "vtables", "fixture", "--class-filter", "Foo"])
        .unwrap();
}
...
fn language_surface_flags_parse_and_validate_closed_values() {
    ...
    .unwrap();
    assert!(
        macho::cli::commands::parse_only(["macho", "objc", "fixture", "--presence", "guessed",])
            .is_err()
    );
    macho::cli::commands::parse_only([
        "macho",
    ...
    .unwrap();
    assert!(macho::cli::commands::parse_only(["macho", "swift", "fixture", "--exact"]).is_err());
    assert!(
        macho::cli::commands::parse_only(["macho", "swift", "fixture", "--state", "guessed",])
            .is_err()
    );
}
