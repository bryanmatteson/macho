use crate::audit::{AuditFinding, AuditReport, AuditSeverity};
use crate::report::{ObjCReport, RecoveryReport, SwiftReport};
use crate::strings::FoundString;
use crate::xref::ranges::RangeEntry;
use crate::xref::refs::Xref;
