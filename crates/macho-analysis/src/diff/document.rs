...
fn diff_complete_values(
    ...
    match domain {
        ...
        AnalysisDomain::Strings => diff_strings(
            &decode::<Vec<crate::strings::FoundString>>(old)?,
            &decode::<Vec<crate::strings::FoundString>>(new)?,
            arch,
            findings,
        ),
        AnalysisDomain::Ranges => {
            diff_ranges(
                &decode::<Vec<crate::xref::ranges::RangeEntry>>(old)?,
                &decode::<Vec<crate::xref::ranges::RangeEntry>>(new)?,
                arch,
                findings,
            )?;
        }
        AnalysisDomain::Xrefs => {
            diff_xrefs(
                &decode::<Vec<crate::xref::refs::Xref>>(old)?,
                &decode::<Vec<crate::xref::refs::Xref>>(new)?,
                arch,
                findings,
            )?;
        }
