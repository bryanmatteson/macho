...
use crate::reconstruct::swift::{declaration_selection, is_identifier, render_declarations};
use crate::report::{
...
/// ABI field-record flags, mirroring `crate::reconstruct::swift`.
...
pub fn project_swift_headers(report: &mut SwiftReport) -> crate::Result<()> {
...
mod tests {
    ...
    fn a_case_with_mangled_but_unresolved_payload_is_a_gap() {
        ...
        payload.mangled_type = Some(crate::report::HexBytes::from_bytes(b"raw"));
