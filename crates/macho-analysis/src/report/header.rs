...
impl From<&macho_header_syntax::HeaderValidationReport> for HeaderValidationReport {
    fn from(value: &macho_header_syntax::HeaderValidationReport) -> Self {
        Self {
            ...
            diagnostics: value
                ...
                .map(|diagnostic| HeaderValidationDiagnostic {
                    ...
                    severity: match diagnostic.severity {
                        macho_header_syntax::Severity::Info => Severity::Info,
                        macho_header_syntax::Severity::Warning => Severity::Warning,
                        macho_header_syntax::Severity::Error => Severity::Error,
                    },
...
fn validation_code(value: macho_header_syntax::HeaderValidationCode) -> HeaderValidationCode {
    use macho_header_syntax::HeaderValidationCode as Source;
    match value {
