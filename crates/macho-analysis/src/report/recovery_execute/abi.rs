...
fn execute_abi_slice(
    ...
    let target_set = targets
        ...
        .map(EntityId::as_str)
        .collect::<BTreeSet<_>>();
    let symbols = macho.ext::<macho_core::SymbolTable<'_>>()?;
    ...
    for entity in &mut slice.entities {
        ...
        let Some(analysis) = macho_cpp::abi::analyze_symbol_body(macho, &symbols, symbol, None)
        else {
            continue;
        };
...
fn abi_return_class(value: &macho_cpp::CppReturnChannel) -> AbiValueClass {
    match value {
        macho_cpp::CppReturnChannel::GeneralPurpose => AbiValueClass::Integer,
        macho_cpp::CppReturnChannel::FloatingPoint => AbiValueClass::Floating,
        macho_cpp::CppReturnChannel::AggregateIndirect => AbiValueClass::Indirect,
        macho_cpp::CppReturnChannel::Void => AbiValueClass::Void,
        macho_cpp::CppReturnChannel::Unknown => AbiValueClass::Unknown,
        _ => AbiValueClass::Unknown,
    }
}

fn abi_argument_class(value: &macho_cpp::ArgumentTypeHint) -> AbiValueClass {
    match value {
        macho_cpp::ArgumentTypeHint::FloatingPoint => AbiValueClass::Floating,
        macho_cpp::ArgumentTypeHint::Scalar => AbiValueClass::Integer,
        macho_cpp::ArgumentTypeHint::Pointer
        | macho_cpp::ArgumentTypeHint::CString
        | macho_cpp::ArgumentTypeHint::ClassPointer { .. }
        | macho_cpp::ArgumentTypeHint::ObjcObject
        | macho_cpp::ArgumentTypeHint::StructPointer => AbiValueClass::Indirect,
        macho_cpp::ArgumentTypeHint::Unknown => AbiValueClass::Unknown,
        _ => AbiValueClass::Unknown,
    }
}
