...
fn render_objc_property(
    property: &crate::ObjectiveCProperty,
    output: &mut String,
) -> Result<(), RenderError> {
...
fn render_objc_access(access: crate::ObjectiveCAccess) -> &'static str {
    match access {
        crate::ObjectiveCAccess::Public => "@public",
        crate::ObjectiveCAccess::Protected => "@protected",
        crate::ObjectiveCAccess::Private => "@private",
        crate::ObjectiveCAccess::Package => "@package",
    }
}

fn render_objc_property_attribute(attribute: crate::ObjectiveCPropertyAttribute) -> &'static str {
...
fn render_protocol_list(protocols: &[crate::Identifier], output: &mut String) {
...
fn render_path(path: &crate::IdentifierPath) -> String {
    path.components()
        .iter()
...
#[cfg(test)]
mod tests {
    use crate::{HeaderParser, TreeSitterHeaderParser};
