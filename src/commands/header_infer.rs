...
fn validators() -> [&'static dyn macho::header_infer::ModelOutputValidator; 1] {
...
fn print_bundle_validation_report(report: &macho::header_infer::BundleValidationReport) {
...
fn print_validation_report(report: &macho::header_infer::ValidationReport) {
    println!("valid: {}", report.valid);
