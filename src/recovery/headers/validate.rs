...
use crate::recovery::headers::schema::EvidenceBundle;
...
pub trait ModelOutputValidator {
    ...
    fn validate(
        ...
        output: &crate::recovery::headers::ModelOutput,
        header_text: &str,
...
impl ModelOutputValidator for ClangSyntaxValidator {
    ...
    fn validate(
        &self,
        bundle: &EvidenceBundle,
        _output: &crate::recovery::headers::ModelOutput,
        header_text: &str,
    ) -> crate::Result<Vec<ValidationIssue>> {
...
pub fn validate_output(
    ...
    let header_text = crate::recovery::headers::render_header(output);
    let mut issues = Vec::new();
