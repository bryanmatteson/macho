...
fn validators() -> [&'static dyn crate::recovery::headers::ModelOutputValidator; 1] {
...
fn print_bundle_validation_report(report: &crate::recovery::headers::BundleValidationReport) {
...
fn print_validation_report(report: &crate::recovery::headers::ValidationReport) {
    println!("valid: {}", report.valid);
